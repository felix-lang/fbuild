...
def config_complex_h(conf):
    ...
    complex_h = conf.setdefault('headers', {}).setdefault('complex_h', {})
...
def config_stdbool_h(conf):
    ...
    stdbool_h = conf.setdefault('headers', {}).setdefault('stdbool_h', {})
...
def config_stdint_h(conf):
    ...
    stdint_h = conf.setdefault('headers', {}).setdefault('stdint_h', {})
...
def config_stdio_h(conf):
    stdio_h = conf.setdefault('headers', {}).setdefault('stdio_h', {})
